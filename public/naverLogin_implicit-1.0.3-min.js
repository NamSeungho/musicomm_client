...
var naver_id_login = function (client_id,redirect_uri)
{
    ...
    this.get_naver_userprofile = function(callback_func1) {
        ...
        script.src = 'https://openapi.naver.com/v1/nid/getUserProfile.json?response_type=json&oauth_callback=naverLoginCallback&access_token=' + this.oauthParams.access_token;
        document.getElementsByTagName('head')[0].appendChild(script);
        window.naverLoginCallback = (result) => {
            try {
