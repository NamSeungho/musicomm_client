        ...
        <section id="latest_music_container">
            <div class="container">
                ...
                <div id="music_video_list_wrap">
                    <div class="music_video_list_item" v-for="(music, index) in latestMusic" v-bind:key="index">
                        <div class="music_video_list_item_wrap">
                            <div>
                                <div class="music_video_list_item_thumbnail_cover" v-bind:class="{ active: music.isActive }" @mouseenter="music.isActive = true" @mouseleave="music.isActive = false" @mousemove="music.isActive = true" @click="playLatestMusic(music.video)">
                            ...
                            <div class="music_video_list_item_fav_div">
                                <img v-if="music.isFavorite >= 0" class="music_video_list_item_fav_img on" src="/images/icon_fav_on.png" alt="즐겨찾기" @click="favoriteMusic(music.video, false)" />
                                <img v-else class="music_video_list_item_fav_img" src="/images/icon_fav_off.png" alt="즐겨찾기 취소" @click="favoriteMusic(music.video, true)" />
                            </div>
                        </div>
                    </div>
                </div>
